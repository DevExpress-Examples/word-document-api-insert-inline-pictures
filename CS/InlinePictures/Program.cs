...
namespace InlinePictures {
    static class Program {
        ...
        static void Main()
        {
            ...
            DocumentPosition pos = doc.Paragraphs[doc.GetParagraph(rangeFound.End).Index + 2].Range.Start;
            ...
            DocumentImageCollection images = server.Document.GetImages(doc.Range);
